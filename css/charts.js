...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // D2.1. variable that filters the metadata array for the object with the desired sample number.
    ...
    // D2.2. Create a variable that holds the first sample in the metadata array.
    ...
    // 6A. Variable that will hold washing frequency 
    ...
    // });
  // }
      // // 9A. Create the trace for the bubble chart.
      // var bubbleData = [{
      //   x: otuIds,
      //   y: sampleValues,
      //   text: otuLabels,
      ...
      // // 9B. Create the layout for the bubble chart.
      // var bubbleLayout = {
